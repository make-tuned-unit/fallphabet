-- Fix Security Definer View Issues (Updated with explicit security_invoker syntax)
...
-- Recreate daily_challenge_today view with explicit SECURITY INVOKER
CREATE OR REPLACE VIEW public.daily_challenge_today 
...
-- Recreate top_scores view with explicit SECURITY INVOKER
CREATE OR REPLACE VIEW public.top_scores 
WITH (security_invoker=on) AS
SELECT 
    player_name,
    score,
